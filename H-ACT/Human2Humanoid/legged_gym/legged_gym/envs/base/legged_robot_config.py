...
class LeggedRobotCfg(BaseConfig):
    ...
    class domain_rand:
        ...
        randomize_link_body_names = [
            'world', 'base_link', 'left_hip_yaw_link', 'left_hip_roll_link', 'left_hip_pitch_link', 'left_knee_link', 
            'left_ankle_link', 'right_hip_yaw_link', 'right_hip_roll_link', 'right_hip_pitch_link', 'right_knee_link', 
            'right_ankle_link', 'waist_yaw_link', 'left_shoulder_pitch_link', 'left_shoulder_roll_link', 'left_shoulder_yaw_link', 
    ...
    class rewards:
        ...
        teleop_body_rot_selection = ['base']
        teleop_body_vel_selection = ['base']
        teleop_body_pos_selection = ['base']
        teleop_body_ang_vel_selection = ['base']
    ...
    class extra:
        ...
        upper_link_idx = (range(16, 33))
        lower_link_idx = (range(16))
        
        vr3_keypoints_idx = (18, 25, 32)
        
        upper_joint_idx = (range(15, 32))
        lower_joint_idx = (range(15))
        dof_num = 32
        torso_link = "waist_yaw"
        
        extend: bool = False
        extend_parent_ids = [] # [15, 19, 0]
        extend_local_translation = [] # [[0.3, 0, 0], [0.3, 0, 0], [0, 0, 0.75]]
        extend_local_rotation = [] # [[1, 0, 0, 0]]
        
        hand_idx = (24, 31)
        
        ignored_joint_idx = (5, 11)
