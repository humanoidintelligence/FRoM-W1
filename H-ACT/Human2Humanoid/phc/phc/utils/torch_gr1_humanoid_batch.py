...
GR1_ROTATION_AXIS = torch.tensor([[
    [1, 0, 0],            #   'link_left_thigh_roll', 
    [0, 0, 1],            #   'link_left_thigh_yaw', 
    [0, 1, 0],            #   'link_left_thigh_pitch', 
    [0, 1, 0],            #   'link_left_shank_pitch', 
    [0, 1, 0],            #   'link_left_foot_pitch', 
    [1, 0, 0],              #   'link_left_foot_roll', 
    [1, 0, 0],              #   'link_right_thigh_roll', 
    [0, 0, 1],            #   'link_right_thigh_yaw', 
    [0, 1, 0],            #   'link_right_thigh_pitch', 
    [0, 1, 0],            #   'link_right_shank_pitch', 
    [0, 1, 0],             #   'link_right_foot_pitch', 
    [1, 0, 0],              #   'link_right_foot_roll', 
    [0, 0, 1],            #   'link_waist_yaw', 
    [0, 1, 0],              #   'link_waist_pitch', 
    [1, 0, 0],              #   'link_waist_roll', 
    [0, 0, 1],            #   'link_head_yaw', 
    [1, 0, 0],              #   'link_head_roll', 
    [0, 1, 0],              #   'link_head_pitch', 
    [0, 1, 0],            #   'link_left_upper_arm_pitch', 
    [1, 0, 0],              #   'link_left_upper_arm_roll', 
    [0, 0, 1],            #   'link_left_upper_arm_yaw', 
    [0, 1, 0],            #   'link_left_lower_arm_pitch', 
    [0, 0, 1],            #   'link_left_hand_yaw', 
    [1, 0, 0],              #   'link_left_hand_roll', 
    [0, 1, 0],             #   'link_left_hand_pitch', 
    [0, 1, 0],             #   'link_right_upper_arm_pitch', 
    [1, 0, 0],              #   'link_right_upper_arm_roll', 
    [0, 0, 1],            #   'link_right_upper_arm_yaw', 
    [0, 1, 0],              #   'link_right_lower_arm_pitch', 
    [0, 0, 1],            #   'link_right_hand_yaw', 
    [1, 0, 0],              #   'link_right_hand_roll', 
    [0, 1, 0],             #   'link_right_hand_pitch'
]])

class Humanoid_Batch:
    def __init__(self, mjcf_file = f"resources/robots/gr1/gr1t1.xml", extend_hand = False, extend_head = False, device = torch.device("cpu")):
    ...
    def fk_batch(self, pose, trans, convert_to_mat=True, return_full = False, dt=1/30):
        ...
        pose = pose[..., :len(self._parents), :] # gr1 fitted joints might have extra joints
