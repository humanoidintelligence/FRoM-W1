...
from .utils import quaternion_to_matrix, axis_angle_to_quaternion, matrix_to_quaternion, wxyz_to_xyzw
import xml.etree.ElementTree as ETree
from easydict import EasyDict
from .rotation3d import *
from .robot_config import G1Config, H1Config
from typing import Union

class Humanoid_Batch:
    def __init__(self, cfg: Union[G1Config, H1Config], device = torch.device("cpu")):
        self.cfg = cfg
