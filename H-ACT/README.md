...
## 🧩 Environment Setup & Model Preparation
...
You can modify **lines 47–48** in `main.py` to select a target robot.
...
Our deployment module also includes **pretrained policy models**—one for **Unitree G1** and one for **Unitree H1**—which can be used directly.

If you would like to train your own policy, please refer to our documentation:  
👉 [Train](Human2Humanoid/README-zh.md)
...
Once you obtain your final policy model, proceed to the section on **[Simulation & Real-World Deployment](#仿真与真机部署)** to execute your actions on real robots.
...
👉 [https://github.com/HybridRobotics/whole_body_tracking?tab=readme-ov-file#policy-training](https://github.com/HybridRobotics/whole_body_tracking?tab=readme-ov-file#policy-training)

## TWIST Policy Training

Refer to the official TWIST documentation:
👉 [https://github.com/YanjieZe/TWIST](https://github.com/YanjieZe/TWIST)
