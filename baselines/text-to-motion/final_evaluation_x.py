...
def plot_t2m(data, save_dir, captions):
    ...
    for i, (caption, joint_data) in enumerate(zip(captions, data)):
        ...
        plot_3d_motion(save_path, paramUtil.t2m_kinematic_chain, joint, title=caption, fps=30)
...
def parse_args():
    parser = argparse.ArgumentParser(description='t2m eval')

    parser.add_argument('--dataset_name', type=str, help='dataset_name')
    parser.add_argument('--comp_name', type=str, help='comp name')
    # parser.add_argument('--length_est_name', type=str, help='length_est name')
    parser.add_argument('--text_mot_match_name', type=str, help='text_mot_match name')
...
if __name__ == '__main__':
    ...
    text_mot_match_name = args.text_mot_match_name
    device_id = args.device_id
    
    dataset_opt_path = f'./checkpoints/{dataset_name}/{comp_name}/opt.txt'
    # dataset_opt_path = './checkpoints/kit/Comp_v6_KLD005/opt.txt'
    eval_motion_loaders = {
        ################
        ## HumanML3D Dataset##
        ################
        comp_name: lambda: get_motion_loader(
            f'./checkpoints/{dataset_name}/{comp_name}/opt.txt',
    ...
    wrapper_opt.text_mot_match_name = text_mot_match_name
    eval_wrapper = EvaluatorModelWrapper(wrapper_opt)

    log_file = f'./eval_log/{dataset_name}_{comp_name}_{text_mot_match_name}_evaluation.log'
    evaluation(log_file)
