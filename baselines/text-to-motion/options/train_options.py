...
class TrainCompOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--eval_every_e', type=int, default=100, help='Frequency of animation results (by epoch)')
...
class TrainTexMotMatchOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--comp_name', type=str, default="Comp_v6_KLD01", help='comp name for mean and std.')
